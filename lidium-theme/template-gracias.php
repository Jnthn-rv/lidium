...
<body <?php body_class('antialiased'); ?>>
    ...
    <main class="py-20">
        <div class="container mx-auto px-4">
            <div class="bg-white p-8 sm:p-12 rounded-2xl shadow-lg max-w-2xl mx-auto text-center">
                ...
                <h1 class="text-3xl font-bold text-[#1f1f1f]"><?php the_field('thank_you_title'); ?></h1>
                <p class="mt-4 text-gray-600"><?php the_field('thank_you_subtitle'); ?></p>
                <?php if( get_field('thank_you_button_url') && get_field('thank_you_button_text') ): ?>
                    <a href="<?php the_field('thank_you_button_url'); ?>" class="mt-8 inline-block bg-[#7732a8] text-white font-bold py-3 px-8 rounded-lg hover:bg-[#481262] transition-colors">
                        <?php the_field('thank_you_button_text'); ?>
                    </a>
                <?php endif; ?>
            </div>
        </div>
